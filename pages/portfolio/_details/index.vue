<template>
    <div>
        <v-skeleton-loader 
            boilerplate height="70vh" tile type="card" class="mx-5"
            v-if="loading"
        />
        <div class="portfolio" v-else>
            ...
            <section class="tech-sheet">
                ...
                <em>
                    Technologies and languages utilized in this project
                </em>
            ...
            <section class="tech-sheet">
                ...
                <ul>
                    <li v-if="project.availability">
                        ...
                        <a href="https://kelsaxchange.com" class="ilink">
                            https://kelsaxchange.com
                        </a>
                    </li>
                    <li v-else>
                        This project offline at the moment
                    </li>
                </ul>
            </section>
            <section class="tech-sheet">
...
export default class ProjectDetail extends Vue{
    ...
    get carouselItems(){
        if (Object.values(this.project).length < 1)
            return []
